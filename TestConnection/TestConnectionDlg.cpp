...
// TestConnectionDlg.cpp : implementation file
//
...
CTestConnectionDlg::CTestConnectionDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_TESTCONNECTION_DIALOG, pParent)
{
...
{
	CDialogEx::DoDataExchange(pDX);
	DDX_Control(pDX, IDC_BUTTON1, T_Btn);
}
...
BEGIN_MESSAGE_MAP(CTestConnectionDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON1, &CTestConnectionDlg::OnClickedButton1)
END_MESSAGE_MAP()


// CTestConnectionDlg message handlers
...
void CTestConnectionDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CTestConnectionDlg::OnPaint()
{
	if (IsIconic())
	{
...
HCURSOR CTestConnectionDlg::OnQueryDragIcon()
{
...
void CTestConnectionDlg::OnClickedButton1()
{
	CDatabase database;
	CString sDsn;
